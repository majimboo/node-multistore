...
#include <nan.h>
#include <stdio.h>
#include "msgpack/ext_date.h"
#include "ext.h"
#include "msgpack/big_integer.hpp"
...
static void v8_to_msgpack(Handle<Value> v8obj, msgpack_object *mo, msgpack_zone *mz, size_t depth);
...
v8_to_msgpack(Handle<Value> v8obj, msgpack_object *mo, msgpack_zone *mz, size_t depth) {
    ...
    if (v8obj->IsUndefined() || v8obj->IsNull()) {
        ...
        v8_to_msgpack_date(v8obj, mo, mz, 0xfe);
    ...
    } else if (msgpack::big_integer::IsBigInteger(v8obj)) {
        int64_t result = msgpack::big_integer::Int64Value(v8obj);
        int8_t  signum = msgpack::big_integer::Signum(v8obj);
...
msgpack_to_v8(msgpack_object *mo) {
    ...
    case MSGPACK_OBJECT_POSITIVE_INTEGER:
        ...
        if (mo->via.u64 > INT64_C(9007199254740991)) {
            return msgpack::big_integer::Create(to_string(mo->via.u64));
        } else {
    ...
    case MSGPACK_OBJECT_NEGATIVE_INTEGER:
        ...
        if (mo->via.i64 > INT64_C(9007199254740991) || mo->via.i64 < INT64_C(-9007199254740991)) {
            return msgpack::big_integer::Create(to_string(mo->via.i64));
        } else {
    ...
    case MSGPACK_OBJECT_EXT: {
        ...
        msgpack_sbuffer_write(sb, mo->via.ext.data, mo->via.ext.size);

        Local<Object> slowBuffer = NanNewBufferHandle(
          sb->data, sb->size, _free_sbuf, (void *)sb
        );

        o->Set(String::New("_msgpack_packed_data"), slowBuffer);
        o->Set(String::New("_msgpack_packed_type"), Integer::New(static_cast<int8_t>(mo->via.ext.type)));
...
extern "C" void
init(Handle<Object> target, Handle<Object> module) {
    NanScope();
    ...
    Local<Value> args[] = { String::New("bignumber") };

    Local<Object> BigNumber  = require->Call(module, 1, args)->ToObject();
    msgpack::big_integer::SetConstructor(Handle<Function>::Cast(
                                             BigNumber->Get(
                                                 String::New("BigInteger"))));
