...
describe('Date::unpack', function() {
  ...
  it('should be the same date', function(done) {
    var date1 = new purr.Date(1397554144485); // Tue Apr 15 2014 17:29:04 GMT+0800 (PHT)
  ...
  it('should return ext type 2', function(done) {
    var date     = new purr.Date(1397554144485); // Tue Apr 15 2014 17:29:04 GMT+0800 (PHT)
    var packed   = purr.pack(date);
    var unpacked = purr.unpack(packed);
